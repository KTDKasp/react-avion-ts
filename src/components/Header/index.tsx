			...
			<div className="header__top">
				<div className="container header__container header__top-container">
					<a href="#" className="logo">
						<img src="/svg/Avion.svg" alt="Avion Logo" />
					</a>
					<div className="header__details">
						...
						<div className="header__buttons">
							<button className="btn-reset header__button" aria-label="Search">
								<svg
									width="16"
									height="16"
									viewBox="0 0 16 16"
							...
							<button className="btn-reset header__button" aria-label="Cart">
								<svg
									width="16"
									height="16"
									viewBox="0 0 16 16"
							...
							<button className="btn-reset header__button" aria-label="Profile">
								<svg
									width="16"
									height="16"
									viewBox="0 0 16 16"
